...
class $AssetsFontsGen {
  ...
  List<String> get values =>
      [poppinsBold, poppinsMedium, poppinsRegular, robotoRegular];
}
...
class Assets {
  ...
  static const AssetGenImage warehouseBg =
      AssetGenImage('assets/warehouse_bg.jpg');
  static const AssetGenImage waresysLogo =
      AssetGenImage('assets/waresys_logo.jpg');

  /// List of all assets
  static List<dynamic> get values => [apple, google, warehouseBg, waresysLogo];
}
